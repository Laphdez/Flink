...
public class Iterate {
	...
	public static void main(String[] args) throws Exception {
		...
		});   //Incrementa en 1 los valores    1,1   2,1  3,1   4,1   5,1   6,1 
		...
		// retroalimentar los datos a la siguiente iteración
		iteration.closeWith(notEqualtoten);					//Mientras sea verdadero sigue la iteracion?
		
		// no retroalimentar los datos a la siguiente iteración
		...
		equaltoten.writeAsText("/home/flink/Documentos/ten");
		
		env.execute("Iteraccion");
	}
}
